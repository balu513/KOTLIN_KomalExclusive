package com.komala.kotlin_komalexclusive.carousel;
...
public class ArticlesCarouselViewPager extends ViewPager implements ViewPager.PageTransformer {
    public static final String TAG = "ArticlesCarouselViewPager";
    ...
    public ArticlesCarouselViewPager(Context context) {
        this(context, null);
    }

    public ArticlesCarouselViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
